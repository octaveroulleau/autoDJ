...
from similariy_learning.models.dielemann.build import GlobalLPPooling1D
...
def asynchronous_learning(audioSet, 
    ...
    if transfer_learning == False:
        ...
        model_base_path = './similarity_learning/models/dielemann/models/'+model_base_name+'_base.h5'
