...
# audioSet.files = audioSet.files[0:100]
# batch_size = 5
# nb_frames = 100
# mod_options = {
#         'activation': 'relu',
...
model_name = 'genre_full_artist_full_key_full' # 'genre_full_artist_full_key_full' # 'artist_full'
model_cnn = cnn_load.load_CNN_model(model_name)

X_embed = np.asarray(model_cnn.predict(X, verbose = 1))
vae_train.train_and_save(X_embed, 20, 'vae_full_testparams')  # max_epochs = 1000 # 30
